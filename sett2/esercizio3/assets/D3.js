...
for(let i = 0; i < starWarsCharacters.length; i++){
  const cCharacter = starWarsCharacters[i];
  if (cCharacter.gender === 'female'){
    femaleCharacters.push(cCharacter);
  }
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const cGender = starWarsCharacters[i];

  if (cGender.gender === "n/a") {
    cGender.gender = "robot";
  }
}
...
*/
console.log("Number of characters before:", characters.length);

for (let i = 0; i < characters.length; i++) {
  const currentCharacter = characters[i];
  for (let a = 0; a < femaleCharacters.length; a++) {
    if (femaleCharacters[a].name === currentCharacter) {
...
console.log("The character is:", selectedCharacter.name);
